    ...
    def __init__(self, root):
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Kelaniya":
                    switch = {"Gampaha": 9, "Colombo": 10, "Nawala": 14, "Kelaniya": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Gampaha":
                    switch = {"Gampaha": 0, "Colombo": 19, "Nawala": 23, "Kelaniya": 9}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Colombo":
                    switch = {"Gampaha": 19, "Colombo": 0, "Nawala": 6, "Kelaniya": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Nawala":
                    switch = {"Gampaha": 23, "Colombo": 6, "Nawala": 0, "Kelaniya": 14}
                    Km.set(switch[varl2.get()])
        ...
        self.cboPickup = ttk.Combobox(TravelFrame, textvariable=varl1, state='readonly', font=('arial', 20, 'bold'),
                                      width=14)
        self.cboPickup['value'] = ('', 'Kelaniya', 'Nawala', 'Colombo', 'Gampaha')
        self.cboPickup.current(0)
        ...
        self.cboDrop = ttk.Combobox(TravelFrame, textvariable=varl2, state='readonly', font=('arial', 20, 'bold'),
                                    width=14)
        self.cboDrop['value'] = ('', 'Gampaha', 'Colombo', 'Kelaniya', 'Nawala')
        self.cboDrop.current(0)
        ...
        self.txtCabTax = Label(TravelFrame, font=('arial', 14, 'bold'), textvariable=CabTax, bd=6, width=18, bg="white",
        ...
        self.txtPaidTax = Label(CostFrame, font=('arial', 14, 'bold'), textvariable=PaidTax, bd=7, width=10,
        ...
        self.chkStandard = Radiobutton(Book_Frame, text="Threewheelar", value=1, variable=carType,
        ...
        self.chkFordGalaxyd = Radiobutton(Book_Frame, text="Car", value=2, variable=carType, font=('arial', 14, 'bold'),
                                          command=selectCar).grid(row=1, column=0, sticky=W)
        self.txtFordGalaxy = Label(Book_Frame, font=('arial', 14, 'bold'), width=7, textvariable=FordGalaxy, bd=5,
                                   state=DISABLED, justify=RIGHT, bg="white", relief=SUNKEN)
        self.txtFordGalaxy.grid(row=1, column=1)

        self.chkFordMondeo = Radiobutton(Book_Frame, text="Van", value=3, variable=carType, font=('arial', 14, 'bold'),
                                         command=selectCar).grid(row=2, column=0, sticky=W)
        self.txtFordMondeo = Label(Book_Frame, font=('arial', 14, 'bold'), width=7, textvariable=FordMondeo, bd=5,
                                   state=DISABLED, justify=RIGHT, bg="white", relief=SUNKEN)
